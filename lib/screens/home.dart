...
import 'package:notes/baza/database.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Icon(Icons.loupe), //attach_file,
      ),
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Icon(
                isFlagOn ? Icons.bookmark: OMIcons.bookmark,
              ),
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  IconButton(
                    icon: Icon(isSearchEmpty ? Icons.search : Icons.backspace,
                        color: Colors.grey.shade300),
    ...
    return Row(
      children: <Widget>[
        AnimatedContainer(
          ...
          curve: Curves.easeIn,
          margin: EdgeInsets.only( bottom: 32, left: 115),
  ...
  Widget buildImportantIndicatorText() {
    return AnimatedCrossFade(
      ...
      firstChild: Padding(
        ...
        child: Text(
          'ОТОБРАЖАЮТСЯ ВАЖНЫЕ'.toUpperCase(),
          style: TextStyle(
